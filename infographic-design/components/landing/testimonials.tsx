...
const testimonials = [
  {
    ...
    company: "ПромСтройПроект",
    initials: "АИ",
    text: "Раньше на поиск нужного пункта СП и проверку формул уходило по 2-3 часа. С НормаКалк это занимает минуты. Пояснительная записка собирается автоматически — это просто находка.",
  },
  {
    name: "Марина Козлова",
    role: "Инженер-расчётчик",
    company: "СтальКонструкция",
    initials: "МК",
  ...
  },
  {
    ...
    company: "АрхСтройГрупп",
    initials: "ДП",
    text: "Перевёл весь отдел из 8 человек на НормаКалк. Единый формат записок, общая база расчётов, актуальные нормы. Экспертиза проходит с первого раза.",
  },
];
