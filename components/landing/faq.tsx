...
const faqs = [
  {
    ...
    a: "Нет. Каркас не заменяет программные комплексы для конечно-элементного анализа. Мы решаем другую задачу: быстрый доступ к нормативам СП, ручные проверочные расчёты по формулам из норм, чек-листы и автоматическое оформление пояснительной записки. Каркас дополняет ваш основной инструмент.",
  },
  {
  ...
  },
  {
    ...
    a: "Все формулы взяты напрямую из официальных текстов СП без изменений. Каждый калькулятор содержит ссылку на конкретный пункт нормы. Вы всегда можете проверить логику расчёта и сверить с первоисточником. Каркас — это инструмент для инженера, а не замена инженерного суждения.",
  },
  {
  ...
  {
    q: "Подходит ли Каркас для проектных бюро?",
  ...
  },
  {
    ...
    a: "На данный момент Каркас — это веб-приложение, для работы нужен интернет. Однако вы можете в любой момент скачать пояснительную записку или результаты расчётов в DOCX/PDF и работать с ними офлайн. В планах — PWA-версия с базовым офлайн-доступом.",
  },
  {
